...
@section ('contenido')
	...
	{!!Form::model($consulta,['method'=>'PATCH','route'=>['tableros.consulta.update',$consulta->id_consulta],'files'=>'true'])!!}
    {{Form::token()}}
	<div class="row">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="form-group">
			...
			<input type="text" name="diagnostico" value="{{$consulta->diagnostico}}" class="form-control" placeholder="Diagnistco del paciente">
		</div>
	</div>
